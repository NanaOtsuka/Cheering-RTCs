		...
		while (m_voiceIn.isNew())
		{
			...
			vo = m_voice.data;
				...
				if (vo == 1 ){
					...
					std::cout << "vo = " << vo << std::endl;
					m_Alarm_Sound = "Count5.wav";
					sound();
					
				}

				else if (vo % 4 == 0 && vo != firstcou && firstcou - vo != 3){
					m_Alarm_Sound = "hagemashi1.wav";
					sound();
				}

				else if (vo % 6 == 0 && vo != firstcou && firstcou - vo != 3){
					m_Alarm_Sound = "hagemashi4.wav";
					sound();
				}
					...
					m_Alarm_Sound = "last3.wav";
					sound();
				}

				else if (firstcou - vo == 2){
					m_Alarm_Sound = "last2.wav";
					sound();
				}
				else if (firstcou - vo == 1){
					m_Alarm_Sound = "last1.wav";
					sound();
				}
				else if (vo==firstcou){
					std::cout << "vo = " << vo << std::endl;
					m_Alarm_Sound = "owari.wav";
					sound();
