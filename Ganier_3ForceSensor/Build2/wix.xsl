...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/wix:Wix">
    <Wix xmlns="http://schemas.microsoft.com/wix/2006/wi">
      <Product xmlns="http://schemas.microsoft.com/wix/2006/wi" Id="ADB2AC09-9347-481F-9E9B-35E7F1D1F964" Name="Ganier_3ForceSensor " Language="1041" Codepage="932" Version="" Manufacturer="shimon" UpgradeCode="67662EBE-DFB9-4185-A0C8-C0251BB49FBE">
        <Package InstallerVersion="300" Compressed="yes" Languages='1041' SummaryCodepage='932' />
        <Media Id="1" Cabinet="Ganier_3ForceSensor.cab" EmbedCab="yes" />
	  ...
	  -->
          <xsl:apply-templates select="wix:Fragment/wix:DirectoryRef/wix:Component[contains(wix:File/@Source, translate('\bin\Ganier_3ForceSensor.dll','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'))]" />
          <xsl:apply-templates select="wix:Fragment/wix:DirectoryRef/wix:Component[contains(wix:File/@Source, translate('\lib\Ganier_3ForceSensor.lib','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'))]" />
          <xsl:apply-templates select="wix:Fragment/wix:DirectoryRef/wix:Component[contains(wix:File/@Source, translate('\bin\Ganier_3ForceSensorComp.exe','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'))]" />
          <xsl:apply-templates select="wix:Fragment/wix:DirectoryRef/wix:Component[contains(wix:File/@Source, 'RTC.xml')]" />
        </Feature>
	...
	<!-- <Feature Id="SOURCES" Title="" Level="1" Absent="allow" Description="" >-->
          <!-- Start Ripping through the xml -->
	  <!-- <xsl:apply-templates select="wix:Fragment/wix:DirectoryRef/wix:Component[contains(wix:File/@Source, 'Ganier_3ForceSensor100\src')]" /> -->
	  <!-- </Feature> -->
        ...
        <!-- 
        <WixVariable Id="WixUILicenseRtf" Value="C:/workspace/Ganier_3ForceSensor/cmake/License.rtf"/>
        -->
