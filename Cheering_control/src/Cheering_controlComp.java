// -*- Java -*-
/*!
 * @file Cheering_controlComp.java
...
/*!
 * @class Cheering_controlComp
 * @brief Standalone component Class
 *
 */
public class Cheering_controlComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(Cheering_control.component_conf);
      mgr.registerFactory(prop, new Cheering_control(), new Cheering_control());

      // Create a component
      RTObject_impl comp = mgr.createComponent("Cheering_control");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        Cheering_controlComp init = new Cheering_controlComp();
